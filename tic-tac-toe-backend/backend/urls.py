from backend.gameapp.views import RoomsAPI, CurrentGameAPI, NewGameAPI, JoinGameAPI, UserStatsAPI, GameAPI, RanksAPI
...
urlpatterns = [
    ...
    path('api/ranks/', RanksAPI.as_view(), name='ranks'),
]
